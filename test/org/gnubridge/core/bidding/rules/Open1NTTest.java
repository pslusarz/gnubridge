...
public class Open1NTTest extends TestCase {
	public void testOpeningOneNTFirstCall() {
		...
		BiddingRule rule = new Open1NT(a, new Hand("K,2", "A,Q,3", "A,8,6,5,3",
				"K,J,3"));
	...
	public void testCannotOpenOneNTIfInsufficientHCP() {
		Auctioneer a = new Auctioneer(West.i());
		BiddingRule rule = new Open1NT(a, new Hand("K,2", "A,3", "A,8,6,5,3",
				"K,J,3"));
		assertEquals(null, rule.getBid());
	}
	...
	public void testDoNotOpenOneNTOnImbalancedHand() {
		Auctioneer a = new Auctioneer(West.i());
		BiddingRule rule = new Open1NT(a, new Hand("K", "A,Q,3", "A,8,6,5,3",
				"K,J,3,2"));
		assertEquals(null, rule.getBid());
	}
